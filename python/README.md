...
This Python package wraps the functionality of the [`cse355-machine-design` Rust crate](https://crates.io/crates/cse355-machine-design) for better student accessibility.

If you're looking for the Rust crate or if you're trying to build this Python package from source, see our [GitHub repository](https://github.com/DaymudeLab/cse355-machine-design).
